          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {filteredImages.map((img) => (
              ...
              >
                ...
                {/* Metadata */}
                <div className="p-4 flex-grow flex flex-col justify-between gap-2 min-w-0">
                  <h4 className="text-sm font-bold text-white truncate min-w-0" title={img.fileName}>
                    {img.fileName || 'Captured Photo'}
                  </h4>
                  <div className="flex justify-between items-center gap-2 text-[10px] text-slate-500 font-medium">
